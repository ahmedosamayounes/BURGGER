// ignore_for_file: unreachable_switch_case, constant_identifier_names, non_constant_identifier_names

import 'package:burgger_application/core/networking/api_constans.dart';
import 'package:burgger_application/core/networking/api_error_model.dart';
      ...
      if (error.response != null && error.response?.statusCode != null) {
        ...
        if (responseData is Map<String, dynamic>) {
          ...
          return ApiErrorModel(
            ...
            message: responseData.contains('<html>')
