...
class _WebService implements WebService {
  ...
  @override
  Future<LoginResponseModel> login(LoginReqeustModel loginReqeustModel) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(loginReqeustModel.toJson());
  ...
  @override
  Future<ProductOptionModel> getToppings() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ProductOptionModel>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'toppings',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ProductOptionModel _value;
    try {
      _value = ProductOptionModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  @override
  Future<ProductOptionModel> getSideOptions() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  Future<AddCartResponseModel> addToCart(
    ...
    final _options = _setStreamType<AddCartResponseModel>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'cart/add',
  ...
  Future<ProfileResponseModel> updateProfileData(
    ...
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(profileRequestModel.toJson());
    final _options = _setStreamType<ProfileResponseModel>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
