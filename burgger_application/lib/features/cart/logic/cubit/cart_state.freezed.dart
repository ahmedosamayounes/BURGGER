...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  cartLoading,TResult Function( CartResponseModel data)?  cartSuccess,TResult Function( String error)?  cartError,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  cartLoading,required TResult Function( CartResponseModel data)  cartSuccess,required TResult Function( String error)  cartError,}) {final _that = this;
switch (_that) {
case _Initial():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  cartLoading,TResult? Function( CartResponseModel data)?  cartSuccess,TResult? Function( String error)?  cartError,}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case CartLoading() when cartLoading != null:
return cartLoading();case CartSuccess() when cartSuccess != null:
