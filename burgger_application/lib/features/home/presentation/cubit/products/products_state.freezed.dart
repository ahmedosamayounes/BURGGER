...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( _Initial value)  initial,required TResult Function( ProductsStateLoading value)  loading,required TResult Function( ProductsStateSuccess value)  success,required TResult Function( ProductsStateError value)  error,required TResult Function( SelectionChanged value)  selectionChanged,}){
final _that = this;
switch (_that) {
case _Initial():
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( List<ProductEntity> productsDataList)?  success,TResult Function( ErrorHandler errorHandler)?  error,TResult Function()?  selectionChanged,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( List<ProductEntity> productsDataList)  success,required TResult Function( ErrorHandler errorHandler)  error,required TResult Function()  selectionChanged,}) {final _that = this;
switch (_that) {
case _Initial():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( List<ProductEntity> productsDataList)?  success,TResult? Function( ErrorHandler errorHandler)?  error,TResult? Function()?  selectionChanged,}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case ProductsStateLoading() when loading != null:
return loading();case ProductsStateSuccess() when success != null:
...
class ProductsStateSuccess implements ProductsState {
  const ProductsStateSuccess(final  List<ProductEntity> productsDataList): _productsDataList = productsDataList;
  

 final  List<ProductEntity> _productsDataList;
 List<ProductEntity> get productsDataList {
...
@useResult
$Res call({
 List<ProductEntity> productsDataList
});
...
/// Create a copy of ProductsState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? productsDataList = null,}) {
  return _then(ProductsStateSuccess(
null == productsDataList ? _self._productsDataList : productsDataList // ignore: cast_nullable_to_non_nullable
