...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( List<CategoryEntity> categoriesDataList)?  success,TResult Function( ErrorHandler errorHandler)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( List<CategoryEntity> categoriesDataList)  success,required TResult Function( ErrorHandler errorHandler)  error,}) {final _that = this;
switch (_that) {
case _Initial():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( List<CategoryEntity> categoriesDataList)?  success,TResult? Function( ErrorHandler errorHandler)?  error,}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case CategoriesStateLoading() when loading != null:
return loading();case CategoriesStateSuccess() when success != null:
...
class CategoriesStateSuccess implements CategoriesState {
  const CategoriesStateSuccess(final  List<CategoryEntity> categoriesDataList): _categoriesDataList = categoriesDataList;
  

 final  List<CategoryEntity> _categoriesDataList;
 List<CategoryEntity> get categoriesDataList {
...
@useResult
$Res call({
 List<CategoryEntity> categoriesDataList
});
...
/// Create a copy of CategoriesState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? categoriesDataList = null,}) {
  return _then(CategoriesStateSuccess(
null == categoriesDataList ? _self._categoriesDataList : categoriesDataList // ignore: cast_nullable_to_non_nullable
