...
import '../../../../home/presentation/cubit/products/products_state.dart';
...
class ProductDetailsCubit extends Cubit<ProductsState> {
  ...
  List<int> get selectedToppings => List.unmodifiable(_selectedToppings);
  List<int> get selectedSides => List.unmodifiable(_selectedSides);
