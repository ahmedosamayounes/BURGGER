...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( List<OptionEntity> sideOptionsList)?  success,TResult Function( ErrorHandler error)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( List<OptionEntity> sideOptionsList)  success,required TResult Function( ErrorHandler error)  error,}) {final _that = this;
switch (_that) {
case _Initial():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( List<OptionEntity> sideOptionsList)?  success,TResult? Function( ErrorHandler error)?  error,}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case SideOptionsStateLoading() when loading != null:
return loading();case SideOptionsStateSuccess() when success != null:
...
class SideOptionsStateSuccess implements SideOptionsState {
  const SideOptionsStateSuccess(final  List<OptionEntity> sideOptionsList): _sideOptionsList = sideOptionsList;
  

 final  List<OptionEntity> _sideOptionsList;
 List<OptionEntity> get sideOptionsList {
  if (_sideOptionsList is EqualUnmodifiableListView) return _sideOptionsList;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableListView(_sideOptionsList);
}
...
@useResult
$Res call({
 List<OptionEntity> sideOptionsList
});
...
/// Create a copy of SideOptionsState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? sideOptionsList = null,}) {
  return _then(SideOptionsStateSuccess(
null == sideOptionsList ? _self._sideOptionsList : sideOptionsList // ignore: cast_nullable_to_non_nullable
