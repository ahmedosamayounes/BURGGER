...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( List<OptionEntity> toppingsList)?  success,TResult Function( ErrorHandler error)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( List<OptionEntity> toppingsList)  success,required TResult Function( ErrorHandler error)  error,}) {final _that = this;
switch (_that) {
case _Initial():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( List<OptionEntity> toppingsList)?  success,TResult? Function( ErrorHandler error)?  error,}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case ToppingsStateLoading() when loading != null:
return loading();case ToppingsStateSuccess() when success != null:
...
class ToppingsStateSuccess implements ToppingsState {
  const ToppingsStateSuccess(final  List<OptionEntity> toppingsList): _toppingsList = toppingsList;
  

 final  List<OptionEntity> _toppingsList;
 List<OptionEntity> get toppingsList {
  if (_toppingsList is EqualUnmodifiableListView) return _toppingsList;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableListView(_toppingsList);
}
...
@useResult
$Res call({
 List<OptionEntity> toppingsList
});
...
/// Create a copy of ToppingsState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? toppingsList = null,}) {
  return _then(ToppingsStateSuccess(
null == toppingsList ? _self._toppingsList : toppingsList // ignore: cast_nullable_to_non_nullable
