...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ProfileUpdateState<T>);
}
...
/// @nodoc
class $ProfileUpdateStateCopyWith<T,$Res>  {
$ProfileUpdateStateCopyWith(ProfileUpdateState<T> _, $Res Function(ProfileUpdateState<T>) __);
}


/// Adds pattern-matching-related methods to [ProfileUpdateState].
extension ProfileUpdateStatePatterns<T> on ProfileUpdateState<T> {
...
class _Initial<T> implements ProfileUpdateState<T> {
  const _Initial();
...
@override
String toString() {
  return 'ProfileUpdateState<$T>.initial()';
}
...
class Loading<T> implements ProfileUpdateState<T> {
  const Loading();
...
@override
String toString() {
  return 'ProfileUpdateState<$T>.loading()';
}
...
class Success<T> implements ProfileUpdateState<T> {
  const Success(this.data);
  

 final  T data;

/// Create a copy of ProfileUpdateState
...
@override
String toString() {
  return 'ProfileUpdateState<$T>.success(data: $data)';
}
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $ProfileUpdateStateCopyWith<T, $Res> {
...
class Error<T> implements ProfileUpdateState<T> {
...
@override
String toString() {
  return 'ProfileUpdateState<$T>.error(error: $error)';
}
...
/// @nodoc
abstract mixin class $ErrorCopyWith<T,$Res> implements $ProfileUpdateStateCopyWith<T, $Res> {
