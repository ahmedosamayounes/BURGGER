...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  profileLoading,TResult Function( ProfileResponseModel data)?  profileSuccess,TResult Function( String error)?  profileError,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  profileLoading,required TResult Function( ProfileResponseModel data)  profileSuccess,required TResult Function( String error)  profileError,}) {final _that = this;
switch (_that) {
case _Initial():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  profileLoading,TResult? Function( ProfileResponseModel data)?  profileSuccess,TResult? Function( String error)?  profileError,}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case ProfileLoading() when profileLoading != null:
return profileLoading();case ProfileSuccess() when profileSuccess != null:
